...
public partial class GameEntity {
    ...
    public void AddUnit(string newName, Lockstep.ECS.ECampType newCamp, int newDetailType, int newHealth, int newDamage, uint newKillerLocalId) {
    ...
    public void ReplaceUnit(string newName, Lockstep.ECS.ECampType newCamp, int newDetailType, int newHealth, int newDamage, uint newKillerLocalId) {
        var index = GameComponentsLookup.Unit;
        var component = (Lockstep.ECS.Game.UnitComponent)CreateComponent(index, typeof(Lockstep.ECS.Game.UnitComponent));
        component.name = newName;
        component.camp = newCamp;
