...
namespace Lockstep.Game {
    public abstract class BaseGameManager : BaseManager {
        public void AssignReference(IContexts contexts, IServiceContainer serviceContainer,
        ...
        public virtual void InitReference(IContexts contexts){
            var ctx = contexts as Contexts;
            _actorContext = ctx.actor;
            _inputContext = ctx.input;
            _gameContext = ctx.game;
            _gameStateContext = ctx.gameState;
        }
