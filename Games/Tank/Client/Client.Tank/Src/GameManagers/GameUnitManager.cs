...
namespace Lockstep.Game {
    ...
    public partial class GameUnitManager : BaseGameManager, IGameUnitService {
        ...
        public override void DoAwake(IServiceContainer services){
            ...
            _gameConfigService = Resources.Load<GameConfig>(ConstGameConfig.ConfigPath);
        }
        ...
        private void CreateItem(LVector2 createPos, int type){
            CreateUnit(createPos, _gameConfigService.itemPrefabs, type, EDir.Up, transParentItem);
        }

        public void CreateCamp(LVector2 createPos, int type = 0){
            CreateUnit(createPos + base._gameConfigService.TankBornOffset, _gameConfigService.CampPrefabs, 0, EDir.Up, transParentItem);
        }
        ...
        public void CreateBullet(LVector2 pos, EDir dir, int type, GameEntity owner){
            ...
            var entity = CreateUnit(createPos, _gameConfigService.bulletPrefabs, type, dir, transParentBullet);
        ...
        public void CreateEnemy(LVector2 bornPos, int type){
            ...
            DelayCall(base._gameConfigService.TankBornDelay,
                () => { CreateUnit(createPos, _gameConfigService.enemyPrefabs, type, dir, transParentEnemy); });
        }
        ...
        public void CreatePlayer(byte actorId, int type){
            ...
            EDir dir = EDir.Up;
            DelayCall(base._gameConfigService.TankBornDelay, () => {
                var entity = CreateUnit(createPos, _gameConfigService.playerPrefabs, type, dir, transParentPlayer);
        ...
        public void Upgrade(GameEntity entity){
            ...
            var ecsPrefab = _gameConfigService.playerPrefabs[targetType];
