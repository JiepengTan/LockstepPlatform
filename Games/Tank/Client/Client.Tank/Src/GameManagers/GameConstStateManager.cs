...
namespace Lockstep.Game {
    public partial class GameConstStateManager : BaseGameManager, IGameConstStateService {
        public static GameConstStateManager Instance { get; private set; }
        public GameConstStateManager(){
            Instance = this;
        }
