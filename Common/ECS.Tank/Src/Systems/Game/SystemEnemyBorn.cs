...
namespace Lockstep.Game.Systems.Game {
    public class SystemEnemyBorn : BaseSystem, IExecuteSystem {
        ...
        public void Execute(){
            if (_gameStateService.curEnemyCountInScene < _constGameStateService.MaxEnemyCountInScene && _gameStateService.remainCountToBorn > 0) {
                ...
                if (_gameStateService.bornTimer < 0) {
                    ...
                    //born enemy
                    var allPoints = _constGameStateService.enemyBornPoints;
