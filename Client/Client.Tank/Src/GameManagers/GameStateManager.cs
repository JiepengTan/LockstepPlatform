...
namespace Lockstep.Game {
    ...
    public partial class GameStateManager :BaseGameManager, IGameStateService {
        ...
        public class CopyStateCmd : BaseCommand {
            ...
            public override void Do(object param){
                state = ((GameStateManager) param).curGameState;
            }

            public override void Undo(object param){
                ((GameStateManager) param).curGameState = state;
            }
        }
