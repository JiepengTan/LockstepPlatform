...
namespace Lockstep.Game {
    public class GameCollisionManager : BaseManager, IGameCollisionService, IService {
        ...
        public List<Vector3Int> DebugQueryCollider(EDir dir, LVector2 fTargetHead, LFloat size){
