...
namespace Lockstep.Game {
    public partial class GameMsgManager : BaseGameManager, IGameMsgService {
    ...
    public partial class GameMsgManager  {
    ...
    public partial class GameMsgManager : IRoomMsgHandler, ILoginHandler {
        public static GameMsgManager Instance { get; private set; }
        public GameMsgManager(){
            Instance = this;
        }
