...
{
    public class CalculateBeforeExecuteHashCode : IInitializeSystem, IExecuteSystem
    {                                                         
        private readonly IGroup<GameEntity> _hashableEntities;

        private readonly GameStateContext _gameStateContext;

        public CalculateBeforeExecuteHashCode(Contexts contexts)
        {                                                                                 
        ...
        public void Execute()
        {
            ...
            _gameStateContext.ReplaceBeforeExecuteHashCode(hashCode);
        }       
    }
