...
public static class CollisionUtil {
    ...
    public static LFloat GetMaxMoveDist(EDir dir, LVector2 fHeadPos, LVector2 fTargetHeadPos){
        return GetMaxMoveDist(dir, fHeadPos, fTargetHeadPos, TankUtil.TANK_BORDER_SIZE);
    }
    ...
    public static bool HasColliderWithBorder(EDir dir, LVector2 fTargetHead){
        return HasColliderWithBorder(dir, fTargetHead, TankUtil.TANK_BORDER_SIZE);
    }
    ...
    public static List<Vector3Int> DebugQueryCollider(EDir dir, LVector2 fTargetHead){
        return DebugQueryCollider(dir, fTargetHead, TankUtil.TANK_BORDER_SIZE);
    }
    ...
    public static bool HasCollider(Vector2Int iPos){
        var id = MapManager.Instance.Pos2TileId(iPos, true);
        // 还需要检验炸弹
        if (MapManager.Instance.HasBomb(iPos)) {
            return true;
        }
